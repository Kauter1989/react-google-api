...
if (__DEV__) {
  warning$2$1 = function(condition, format, args) {
...
var warning_1$2$1 = warning$2$1;

function createDeprecationWarning() {
  var alreadyWarned = false;
  return function (message) {
    warning_1$2$1(alreadyWarned, message);
    alreadyWarned = true;
  };
}
...
var Broadcast = function (_React$Component) {
  ...
  Broadcast.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    invariant_1$2$1(this.props.channel === nextProps.channel, "You cannot change <Broadcast channel>");
...
Broadcast.propTypes = {
  channel: propTypes$1.string.isRequired,
  children: propTypes$1.node.isRequired,
  compareValues: propTypes$1.func,
...
Broadcast.childContextTypes = {
  broadcasts: propTypes$1.object.isRequired
};
...
var Subscriber = function (_React$Component) {
  ...
  Subscriber.prototype.getBroadcast = function getBroadcast() {
    ...
    invariant_1$2$1(this.props.quiet || broadcast, '<Subscriber channel="%s"> must be rendered in the context of a <Broadcast channel="%s">', this.props.channel, this.props.channel);
  ...
  var Consumer = function (_React$Component2) {
    ...
    Consumer.prototype.componentDidMount = function componentDidMount() {
      ...
      if (this.broadcast) {
        ...
        warning_1$2$1(this.props.quiet, "<Consumer> was rendered outside the context of its <Provider>");
      }
    };
